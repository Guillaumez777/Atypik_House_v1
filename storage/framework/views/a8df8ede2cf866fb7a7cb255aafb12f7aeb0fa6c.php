            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-block">
                        <div class="card-body">
                            <h2 class="card-title"><a href="<?php echo e(action('UsersController@showHouse', $house->id)); ?>"> <?php echo(substr($house->title, 0, 40));?>  </a></h2> 
                            <h2 class="card-title"> - <?php echo e($house->ville); ?> </h2>
